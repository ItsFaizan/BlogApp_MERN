  ...
  return (
    <div className="relative min-h-screen">
      ...
      >
        ...
        <Link to="/viewblogs"> <button className="bg-gray-600 text-white px-6 py-3 rounded mb-4 mt-4 hover:bg-white hover:text-gray-950 hover:shadow-md transition duration-300">
          Get Started
        </button>
        </Link>
      </div>
